...
class EditSpellsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val editSpellsViewModel =
            ViewModelProvider(this).get(EditSpellsViewModel::class.java)

        _binding = FragmentEditSpellsBinding.inflate(inflater, container, false)
        val root: View = binding.root

        val textView: TextView = binding.textEditSpells
        editSpellsViewModel.text.observe(viewLifecycleOwner) {
            textView.text = it
        }
        return root
    }
